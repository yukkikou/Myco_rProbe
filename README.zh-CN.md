...
- 所需容器（以 `.sif` 文件提供）：
  - `pan_fungi3.sif` / `pan_fungi5.sif` - 包含生物信息学工具的 Python 环境
  - `ciriquant-v1.1.3.sif` - CIRIquant circRNA 分析
  - `blast-2.13.0.sif` - BLAST 序列比对
  - `seqkit-2.2.0.sif` - FASTA/Q 序列操作
  - `samtools-1.14.sif` - SAM/BAM 处理
